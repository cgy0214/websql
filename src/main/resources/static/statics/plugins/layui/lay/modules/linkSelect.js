layui.define(['layer', 'form', 'element', 'laytpl'], function (exports) {
    ...
    Class.prototype.render = function () {
        ...
        linkSelect.cache[that.key]["selectedArr"] = arr.slice(0);
        ;	//将默认选中保存到缓存，以便重载的时候获取
    ...
    Class.prototype.optionFilter = function (dl) {
        ...
        dds.on('click', function (e) {
            ...
            var othis = $(this), value = othis.attr('lay-value'), name = othis.text(),
                thissIndex = othis.attr('lay-sindex');
