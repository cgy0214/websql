...
(function (e, t) {
    ...
    x.event = {
        ...
        props: "altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp templates which".split(" "),
        fixHooks: {},
        keyHooks: {
    ...
    var ht = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|index|output|progress|section|summary|time|video",
