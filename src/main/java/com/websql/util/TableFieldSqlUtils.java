...
public class TableFieldSqlUtils {
    ...
    private static final Map<String, String> DATA_BASE_TABLE_VIEW_SQL = MapUtil.builder(new HashMap<String, String>(8))
            ...
            .put("dm", " SELECT TABLE_NAME AS TABLE_NAME,COLUMN_NAME AS TABLE_FIELD FROM user_tab_columns WHERE  TABLE_NAME NOT LIKE '##%' AND TABLE_NAME NOT LIKE 'SYS%' AND TABLE_NAME NOT LIKE 'DBA%' AND TABLE_NAME NOT IN ('HISTOGRAMS_TABLE', 'DUAL') ORDER BY TABLE_NAME, COLUMN_ID FETCH FIRST 1000 ROWS ONLY ")
